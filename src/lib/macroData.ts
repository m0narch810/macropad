...
export const macroPanels: MacroPanel[] = [
  {
    ...
    series: [
      ...
      blank("us-macro:net-liquidity", "Net Liquidity (BS − TGA − RRP)", "Liquidity actually available to markets", "Derived: WALCL−WTREGEN−RRPONTSYD"),
      blank("us-macro:tga", "Treasury General Account", "Treasury's checking account at the Fed, $B", "FRED WTREGEN"),
      blank("us-macro:reserve-balances", "Reserve Balances", "Bank reserves held at the Fed, $T", "FRED WRESBAL"),
