...
export const INDICATOR_DOCS: Record<string, string> = {
  ...
  "yield-rates:10y-cot":
    "Net speculative positioning in 10 year Treasury futures (ZN). Shows whether leveraged funds and other large speculators are net long or net short the contract, which can flag crowded positioning that is vulnerable to a sharp reversal when it unwinds.",
  "yield-rates:2y-cot":
    "Net speculative positioning in 2 year Treasury futures (ZT), the front end equivalent of the 10 year COT read above.",
  ...
  "cot:es": "Net speculative positioning in S&P 500 e-mini futures (ES). Shows whether large speculators are net long or net short US large cap equities, and the COT index shows where that positioning sits within its own 3 year range, with readings past 90 or below 10 marking crowded trades that have historically unwound violently.",
  "cot:nq": "Net speculative positioning in Nasdaq-100 e-mini futures (NQ), the tech heavy equivalent of the ES read above.",
  "cot:zn": "Net speculative positioning in 10 year Treasury futures (ZN). Duplicated here in the COT Positioning panel alongside the other tracked markets, and also shown under Yield Rates.",
  "cot:zt": "Net speculative positioning in 2 year Treasury futures (ZT), the front end rate exposure equivalent.",
  "cot:gold": "Net speculative positioning in COMEX gold futures (GC). Large net long positioning often reflects safe haven demand or inflation hedging flows building up.",
  "cot:wti": "Net speculative positioning in NYMEX WTI crude oil futures (CL). Tracks how leveraged funds are positioned on the direction of oil prices.",
  "cot:copper": "Net speculative positioning in COMEX copper futures (HG). Copper positioning is often read as a growth expectations signal, since the metal is used broadly across construction and manufacturing.",
  "cot:silver": "Net speculative positioning in COMEX silver futures (SI). Silver has both a monetary, gold-like role and an industrial demand component, so positioning here can reflect either story.",
  "cot:natgas": "Net speculative positioning in NYMEX Henry Hub natural gas futures (NG).",
  "cot:dxy": "Net speculative positioning in ICE US Dollar Index futures (DX). Net long positioning means speculators are betting on further dollar strength against a basket of major currencies.",
  "cot:vix": "Net speculative positioning in VIX futures. This market is structurally net short most of the time, since selling volatility has historically been a positive carry trade, so unusual shifts away from that structural short are worth noting.",
  ...
  "geo:skew": "The SKEW index, built from the pricing of far out of the money S&P 500 put options. Designed to gauge the market implied probability of a tail risk crash, a large sudden decline, that a normal VIX reading would not fully capture since VIX weights near the money options more heavily.",
  "geo:ovx": "The OVX, implied volatility on oil, derived from options on a broad crude oil ETF. Serves as a supply shock gauge, since oil vol tends to spike hardest around geopolitical events that threaten supply.",
  "geo:gvz": "The GVZ, implied volatility on gold, derived from options on a broad gold ETF. Used as a safe haven flow gauge, since gold volatility often rises alongside safe haven demand during periods of market or geopolitical stress.",
